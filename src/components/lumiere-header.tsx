...
/** Même barre que la boutique : la partie lumière suit exactement le reste du site. */
export function LumiereHeader({ locale, dict }: { locale: Locale; dict: Dictionary }) {

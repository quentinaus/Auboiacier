...
export default async function DevisPage({ params }: PageProps<"/[lang]/devis">) {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-[#2b2320]">
      ...
      <section className="border-b border-[#e5ddd3] bg-[#ffffff] px-6 pb-14 pt-16 md:pb-20 md:pt-24">
                ...
                {famille.pieces.map((product) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <h4 className={`${serif.className} text-lg text-[#2b2320] transition-colors duration-300 group-hover:text-black`}>
                          {product.name}
                        </h4>
      ...
      <section className="border-t border-[#e5ddd3] bg-[#ffffff] px-6 py-16 md:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-2xl">
            ...
            {surDevis.map((item) => (
              ...
              >
                ...
                <div className="px-6 py-5">
                  <h3 className={`${serif.className} text-xl text-[#2b2320] transition-colors group-hover:text-black`}>{item.titre}</h3>
